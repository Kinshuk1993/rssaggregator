...
func main() {
	...
	v1Router.Get("/feed_follows", apiCfg.middlewareAuth(apiCfg.handlerCreateFeedFollowsByUserID))
	v1Router.Delete("/feed_follows/{feedFollowID}", apiCfg.middlewareAuth(apiCfg.handlerDeleteFeedFollowsByUserID))
